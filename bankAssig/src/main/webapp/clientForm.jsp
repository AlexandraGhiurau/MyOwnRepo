...
<div class="container">
    ...
    <spring:url value="/client" var="userActionUrl" />
    ...
    <form:form class="form-horizontal" method="post"
        ...
        <spring:bind path="personalNumCode">
            <div class="form-group ${status.error ? 'has-error' : ''}">
                <label class="col-sm-2 control-label">Email</label>
                <div class="col-sm-10">
                    <form:input path="email" class="form-control"
                                id="personalNumCode" placeholder="personalNumCode" />
                    <form:errors path="personalNumCode" class="control-label" />
                </div>
            </div>
        </spring:bind>
        ...
        <spring:bind path="address">
            <div class="form-group ${status.error ? 'has-error' : ''}">
                ...
                <div class="col-sm-10">
                    <form:password path="address" class="form-control"
